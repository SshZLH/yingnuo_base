...
public interface BaseUserService {
     ...
     * @return
     */
    List<JSONObject> getAllRoles(String userId);
     ...
     * @return
     */
    List<JSONObject> listRole(String userId);
     ...
     * @return
     */
    List<JSONObject> listAllPermission(String userId);
     ...
     * @return
     */
    String insertRole(JSONObject jsonObject);
