package com.ynkd.base.controller.shiro.service;
...
public interface UserService {
     ...
     * @return
     */
    JSONObject getAllRoles(String userId);
     ...
     * @return
     */
    JSONObject listRole(String userId);
     ...
     * @return
     */
    JSONObject listAllPermission(String userId);
