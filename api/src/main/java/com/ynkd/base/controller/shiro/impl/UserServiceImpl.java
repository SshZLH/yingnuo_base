...
public class UserServiceImpl implements UserService {
    ...
    public JSONObject listUser(JSONObject jsonObject) {
        ...
        int count = baseUserService.countUser(jsonObject);
        List<JSONObject> list = baseUserService.listUser(jsonObject);
    ...
    public JSONObject addUser(JSONObject jsonObject) {
        int exist = baseUserService.queryExistUsername(jsonObject);
        if (exist > 0) {
            return CommonUtil.errorJson(ErrorEnum.E_10009);
        }
        baseUserService.addUser(jsonObject);
    ...
    public JSONObject getAllRoles(String userId) {
        List<JSONObject> roles = baseUserService.getAllRoles(userId);
    ...
    public JSONObject updateUser(JSONObject jsonObject) {
        baseUserService.updateUser(jsonObject);
    ...
    public JSONObject listRole(String userId) {
        List<JSONObject> roles = baseUserService.listRole(userId);
        return CommonUtil.successPage(roles);
    }
    ...
    public JSONObject listAllPermission(String userId) {
        List<JSONObject> permissions = baseUserService.listAllPermission(userId);
   ...
   // @Transactional(rollbackFor = Exception.class)
    ...
    public JSONObject addRole(JSONObject jsonObject) {
        String i=baseUserService.insertRole(jsonObject);
        baseUserService.insertRolePermission(i, (List<Integer>) jsonObject.get("permissions"));
        return CommonUtil.successJson();
    }
  ...
  //  @Transactional(rollbackFor = Exception.class)
    ...
    public JSONObject updateRole(JSONObject jsonObject) {
        ...
        JSONObject roleInfo = baseUserService.getRoleAllInfo(jsonObject);
    ...
    private void dealRoleName(JSONObject paramJson, JSONObject roleInfo) {
        ...
        if (!roleName.equals(roleInfo.getString("roleName"))) {
            baseUserService.updateRoleName(paramJson);
        }
    }
    ...
    private void saveNewPermission(String roleId, Collection<Integer> newPerms, Collection<Integer> oldPerms) {
        ...
        if (waitInsert.size() > 0) {
            baseUserService.insertRolePermission(roleId, waitInsert);
        }
    }
    ...
    private void removeOldPermission(String roleId, Collection<Integer> newPerms, Collection<Integer> oldPerms) {
        ...
        if (waitRemove.size() > 0) {
            baseUserService.removeOldPermission(roleId, waitRemove);
        }
    }
  ...
  //  @Transactional(rollbackFor = Exception.class)
    ...
    public JSONObject deleteRole(JSONObject jsonObject) {
        ...
        baseUserService.removeRole(jsonObject);
        baseUserService.removeRoleAllPermission(jsonObject);
        return CommonUtil.successJson();
    }
}
